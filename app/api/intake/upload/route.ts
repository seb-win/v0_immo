...
export async function POST(req: Request) {
  try {
    ...
    const simulate = searchParams.get('simulate'); // 'ok' | 'fail' | null
    ...
    // 4) Auf processing setzen (optional)
    ...
    // 5) DEV-Simulation (kein echter Parser nötig)
